            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <p class="card-title">Pending Order List</p>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><img src="{{asset($orders->product->image)}}" alt="" width="35" height="35"></td>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <div class="badge rounded-pill bg-danger">Accepted</div>
                                            @endif
                                    ...
                                    <input type="hidden" class="product_id" name="product_id" value="{{$orders->product->id}}">
                                    <input type="hidden" class="order_id" name="product_id" value="{{$orders->id}}">
                                    @empty
